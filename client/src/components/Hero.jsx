...
const Hero = () => {
  ...
  <div className="flex-col justify-between z-10  w-3/4">
    ...
    <button onClick={()=> navigate('/ai')} className="bg-sb text-black font-medium 
    px-8 py-3 rounded-md w-fit text-lg font-extralight mx-20 cursor-pointer
    transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:brightness-110">Get Started</button>
  </div>
